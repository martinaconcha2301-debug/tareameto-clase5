...
const obtenerTodosLosUsuarios = (req, res) => { 
  ...
  try {
    ...
    sendSuccess(res, "usuarios obtenidos exitosamente", usuarios);

  } catch (error) {
    // si falla algo el send error lo soluciona
...
const obtenerUsuarioPorId = (req, res) => {
  try {
    ...
    sendSuccess (res, usuario, "usuario encontrado");
  } catch (error) {
...
const actualizarUsuario = (req, res) => {
  try {
    ...
    sendSuccess(res, usuarioActualizado, 'usuario actualizado');
